  ...
  return (
    <div className='about'>
      ...
      <h3>Software Engineer</h3>
        ...
        <h3>Tech Stack</h3>
          <p>AWS, Azure, GCP, Terraform, Pulumi, CDK, Docker, Python, Go, TypeScript/JavaScript, React/React Native, Ruby/Rails, SQL, PostgreSQL, HTML, CSS/SASS, SCRUM/Agile Methodology</p>
      </div>
      <img
      id='me'
      src={headshot_lg}
