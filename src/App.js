  ...
  render(){
    ...
    return (
      <div className='App'>
        ...
        <footer className={this.state.show === 'contact' ? 'App-footer hide' : 'App-footer'}>
        ...
        <a href='https://glitch.com/@lgm527' aria-label='glitch' tabIndex={0} className='btn' target='_blank' rel='noopener noreferrer'><img tabIndex={-1} className='btn_content_reversed' width='24' height='24' src={glitchFish} alt='glitch fish' /></a>
        </div>
